...
//					System.out.println("What piece you'd like to move? (notation)");
                                        while(recog.getSource() ==null && recog.getDest() == null){
                                            //espera o reconhecedor receber algo
                                        }
//					System.out.println("Where you'd like to move that piece? (notation)");
					...
					dest = recog.getDest();
                                        ...
                                        //fazer o src dest
                                        /*SpeechToTextConverter conv = new SpeechToTextConverter();
                                        String comm = conv.start();
                                        String text[] = comm.split("to");
                                        1
                                        src = text[0].trim();
                                        dest = text[0].trim();
                                        sys*/
